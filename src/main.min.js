...
var c=this;switch(this.rocketType){case "basic":a=new b["default"](this.parent.x,this.parent.y,a,this.parent);break;case "double":a=new l["default"](this.parent.x,this.parent.y,a,this.parent);break;case "ultra":a=new h["default"](this.parent.x,this.parent.y,a,this.parent);break;case "nuclear":a=new k["default"](this.parent.x,this.parent.y,a,this.parent);break;default:a=new b["default"](this.parent.x,this.parent.y,a,this.parent)}this.rocketPool.push(a);this.cooldown=!0;window.setTimeout(function(){c.cooldown=
