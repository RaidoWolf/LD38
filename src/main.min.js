...
{key:"init",value:function(b,a,d,k){this.live=!0;this.sprite=game.add.sprite(b,a,"rocket");this.sprite.anchor.setTo(.5,.5);this.sprite.scale.setTo(gameScaleBase,gameScaleBase);this.scale=gameScaleBase;this.sprite.animations.add("default",this.frames);this.sprite.animations.play("default",3,!0);this.sprite.angle=d;game.physics.arcade.enable(this.sprite);this.sprite.body.enable=!0;this.sprite.body.collideWorldBounds=!1;this.angle=d;this.owner=k;this.velocity=50}},{key:"update",value:function(){300>
this.velocity&&(this.velocity+=10);this.sprite.body.velocity.x=this.velocity*gameScaleBase*Math.cos(this.angle);this.sprite.body.velocity.y=this.velocity*gameScaleBase*Math.sin(this.angle)}},{key:"x",get:function(){return this.sprite.x},set:function(b){this.sprite.x=b;return!0}},{key:"y",get:function(){return this.sprite.y},set:function(b){this.sprite.y=b;return!0}}]);return a}();c["default"]=a},function(a,c,e){function g(b){return b&&b.__esModule?b:{"default":b}}Object.defineProperty(c,"__esModule",
{value:!0});a=e(18);a=g(a);var d=e(12),d=g(d);e=e(19);e=g(e);window.game=new Phaser.Game(window.innerWidth*window.devicePixelRatio,window.innerHeight*window.devicePixelRatio,Phaser.AUTO,"",{preload:a["default"],create:d["default"],update:e["default"]},!1,!1);window.largestDimension=window.innerWidth>window.innerHeight?window.innerWidth*window.devicePixelRatio:window.innerHeight*window.devicePixelRatio;window.gameScaleBase=largestDimension/800;c["default"]=window.game},function(a,c,e){Object.defineProperty(c,
"__esModule",{value:!0});var g=function(){function b(b,a){for(var d=0;d<a.length;d++){var f=a[d];f.enumerable=f.enumerable||!1;f.configurable=!0;"value"in f&&(f.writable=!0);Object.defineProperty(b,f.key,f)}}return function(a,d,c){d&&b(a.prototype,d);c&&b(a,c);return a}}(),d=(a=e(8))&&a.__esModule?a:{"default":a},b=(e=e(9))&&e.__esModule?e:{"default":e};e=function(){function a(d,c,e){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");d="undefined"!==typeof d?d:game.world.centerX;
...
value:function(){return this.weapon.upgrade()}},{key:"x",get:function(){return this.sprite.x},set:function(b){this.sprite.x=b;return!0}},{key:"y",get:function(){return this.sprite.y},set:function(b){this.sprite.y=b;return!0}}]);return a}();c["default"]=e},function(a,c,e){function g(a,b){if("function"!==typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function, not "+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,
