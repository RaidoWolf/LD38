...
Object.defineProperty(c,"__esModule",{value:!0});a=e(20);a=g(a);var d=e(13),d=g(d);e=e(21);e=g(e);window.game=new Phaser.Game(window.innerWidth*window.devicePixelRatio,window.innerHeight*window.devicePixelRatio,Phaser.AUTO,"",{preload:a["default"],create:d["default"],update:e["default"]},!1,!1);window.largestDimension=window.innerWidth>window.innerHeight?window.innerWidth*window.devicePixelRatio:window.innerHeight*window.devicePixelRatio;window.gameScaleBase=largestDimension/800;c["default"]=window.game},
...
"TIME: "+this.time);this.lastPoints!==this.points&&(this.lastPoints=this.points,this.textPoints.text="POINTS: "+this.points);this.lastDamage!==this.damage&&(this.lastDamage=this.damage,this.textDamage.text="DAMAGE: "+this.damage);this.lastHealth!==this.player.health&&(this.lastHealth=this.player.health,this.textHealth.text="HEALTH: "+this.player.health)}}]);return a}();c["default"]=a},function(a,c,e){Object.defineProperty(c,"__esModule",{value:!0});c["default"]=function d(a,c){if(!(this instanceof
...
game.world.centerY);window.asmallworld=new b["default"](game.world.centerX,game.world.centerY);window.crosshair=new l["default"];window.controller=new h["default"](crosshair,asmallworld);window.scoreboard=new k["default"](asmallworld)};a=e(11);var d=g(a);a=e(2);var b=g(a);a=e(5);var l=g(a);a=e(4);var h=g(a);e=e(10);var k=g(e)},function(a,c,e){Object.defineProperty(c,"__esModule",{value:!0});c["default"]=function(a,c,b){a.addEventListener?a.addEventListener(c,b,!1):a.attachEvent&&a.attachEvent("on"+
c,b)}},function(a,c,e){game.load.spritesheet("asmallworld","assets/asmallworld.png",16,16)},function(a,c,e){game.load.image("crosshair-normal","assets/crosshair-normal.png")},function(a,c,e){game.load.spritesheet("asteroid","assets/asteroid.png",16,16)},function(a,c,e){game.load.image("space","assets/space.png");game.load.spritesheet("sun","assets/sun.png",64,64)},function(a,c,e){game.load.spritesheet("rocket","assets/rocket.png",8,16)},function(a,c,e){Object.defineProperty(c,"__esModule",{value:!0});
c["default"]=function(){e(18);e(15);e(16);e(19);e(17)}},function(a,c,e){Object.defineProperty(c,"__esModule",{value:!0});c["default"]=function(){asmallworld.update();controller.update();scoreboard.update()}},function(a,c,e){e(1)}]);
